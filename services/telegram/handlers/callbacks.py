...
def submenu_keyboard(menu: str, language: str = "fa"):
    ...
    elif menu == "settings": buttons = [[InlineKeyboardButton(t(language, "language"), callback_data="settings_language")], [InlineKeyboardButton(t(language, "analysis_mode"), callback_data="settings_analysis_mode")], [InlineKeyboardButton("🧩 پروفایل تحلیل" if language == "fa" else "🧩 Analysis Profiles", callback_data="settings_profiles")], [InlineKeyboardButton(t(language, "risk"), callback_data="settings_risk")], [InlineKeyboardButton(t(language, "market"), callback_data="settings_market")], [InlineKeyboardButton(t(language, "timeframe"), callback_data="settings_timeframe")], [InlineKeyboardButton(t(language, "notifications"), callback_data="settings_notifications")]]
    else: buttons = []
...
async def menu_callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    profile_callback = data.startswith("profile_") or data == "settings_profiles"
    if data not in ALLOWED_CALLBACKS and not data.startswith("signal_untrack:") and not profile_callback:
