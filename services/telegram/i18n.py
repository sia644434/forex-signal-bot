...
TRANSLATIONS = {
    "fa": {
        ...
        "scan_title": "🔎 <b>اسکن بازار — {timeframe}</b>",
        ...
        "scan_market": "بازار",
        "scan_last_candle": "آخرین کندل",
        "scan_confidence": "اطمینان",
        "scan_quality": "کیفیت",
        "scan_trend": "روند",
        "scan_status_closed": "بسته",
        "scan_status_stale": "داده قدیمی",
        "scan_status_no_data": "بدون داده",
        "scan_status_holiday": "تعطیل",
        "scan_status_unknown": "نامشخص",
    ...
    "en": {
        ...
        "scan_title": "🔎 <b>Market Scan — {timeframe}</b>",
        ...
        "scan_market": "market",
        "scan_last_candle": "last candle",
        "scan_confidence": "confidence",
        "scan_quality": "quality",
        "scan_trend": "trend",
        "scan_status_closed": "closed",
        "scan_status_stale": "stale data",
        "scan_status_no_data": "no data",
        "scan_status_holiday": "holiday",
