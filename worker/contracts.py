...
HEAVY_JOB_TYPES = {
    ...
    "gru_training", "medium_model_training", "correlation_matrix", "portfolio_stress", "stress_sensitivity", "counterfactual_batch", "market_replay", "time_machine", "strategy_evaluation", "robustness_analysis", "research_validation",
}
